...
function IsLogo({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    d: "M18 22 C 18 18, 22 16, 26 16 L 34 16 C 38 16, 42 18, 42 22 C 42 26, 38 28, 34 28 L 26 28 C 22 28, 18 30, 18 34 C 18 38, 22 40, 26 40 L 42 40",
...
function IrisLens() {
  ...
  const AtmoBackground = ({
    ...
    style: {
      position: "absolute",
      inset: 0,
      background: `radial-gradient(ellipse 80% 60% at 50% 40%, rgba(20,44,86,${0.15 * intensity}) 0%, rgba(6,18,44,${0.75 * intensity}) 100%)`
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      inset: 0,
      background: `linear-gradient(to bottom, rgba(6,14,32,${0.25 * intensity}) 0%, rgba(6,14,32,${0.55 * intensity}) 100%)`
    }
  }));
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(AtmoBackground, null), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "relative",
      zIndex: 2,
      padding: "24px 28px",
  ...
  }, /*#__PURE__*/React.createElement(IsLogo, {
    size: 44
  ...
  }, "Your Eyes"), /*#__PURE__*/React.createElement("h1", {
    className: "display",
    style: {
      fontSize: "clamp(46px,11vw,66px)",
      margin: "6px 0",
      fontWeight: 400,
      fontStyle: "italic",
  ...
  }, "hold the"), /*#__PURE__*/React.createElement("h1", {
    className: "display",
    style: {
  ...
  }, "Just as every iS CLINICAL innovation is unique, so is every eye."), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 15,
      fontWeight: 300,
      lineHeight: 1.65,
  ...
  }, "Complete the scan to reveal your table number and begin your GeneXC Firming Eye Gel journey."), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      fontWeight: 300,
      lineHeight: 1.6,
  ...
  }, "Hold your phone approximately 30 cm from your face and follow the on-screen instructions."), /*#__PURE__*/React.createElement("button", {
    ...
    style: {
      position: "absolute",
      inset: 0,
      background: "radial-gradient(ellipse 58% 52% at 50% 42%, rgba(10,20,40,0.25) 38%, rgba(6,14,32,0.88) 100%)",
      pointerEvents: "none"
    }
  ...
  }, /*#__PURE__*/React.createElement(AtmoBackground, {
    intensity: 0.85
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "relative",
  ...
  }, "Identifying your table")) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
    className: "label",
    style: {
  ...
  }, "Try Again"), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("button", {
    className: "btn-ghost",
    style: {
      marginTop: 12
    },
  ...
  }, result.seat === "admin" ? "Access" : "Your Table"), /*#__PURE__*/React.createElement("div", {
    className: "display",
    style: {
      ...
      color: "#fff",
      margin: 0,
      letterSpacing: result.seat === "admin" ? "0.04em" : "-0.01em",
      fontWeight: 400
    }
  ...
  }, it.seat === "admin" ? "Admin" : `Table ${it.seat}`), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      justifyContent: "center",
  ...
  }, expanded.seat === "admin" ? "Admin" : `Table ${expanded.seat}`)), showNamePrompt && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "fixed",
      inset: 0,
  ...
  }, "What's your"), /*#__PURE__*/React.createElement("p", {
    className: "display",
    style: {
      fontSize: 32,
      margin: "0 0 32px",
  ...
  }, "We'll guide you through the iris capture. Please allow camera access to continue."), /*#__PURE__*/React.createElement("button", {
    className: "btn-outline",
    style: {
      width: "100%",
      marginBottom: 10
