...
function HudOverlay({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    d: "M 56 100 L 56 56 L 100 56",
    fill: "none",
    stroke: cyan,
    strokeWidth: "2",
    opacity: ringOpacity
  }), /*#__PURE__*/React.createElement("path", {
    d: "M 300 56 L 344 56 L 344 100",
    fill: "none",
    stroke: cyan,
    strokeWidth: "2",
    opacity: ringOpacity
  }), /*#__PURE__*/React.createElement("path", {
    d: "M 56 300 L 56 344 L 100 344",
    fill: "none",
    stroke: cyan,
    strokeWidth: "2",
    opacity: ringOpacity
  }), /*#__PURE__*/React.createElement("path", {
    d: "M 300 344 L 344 344 L 344 300",
    fill: "none",
    stroke: cyan,
    strokeWidth: "2",
    opacity: ringOpacity
    ...
    opacity: "0.7",
    textAnchor: "end"
  }, "v2.4"), /*#__PURE__*/React.createElement("text", {
    x: "56",
    y: "360",
    fill: cyan,
    fontSize: "8",
    fontFamily: "Inter, monospace",
    opacity: "0.6"
  }, "LAT: ", state === "capturing" ? "LOCKED" : "—"), /*#__PURE__*/React.createElement("text", {
    x: "344",
    y: "360",
    fill: cyan,
    fontSize: "8",
    ...
    return /*#__PURE__*/React.createElement("circle", {
      key: deg,
      cx: 200 + 120 * Math.cos(a),
      cy: 200 + 120 * Math.sin(a),
      r: "4",
      fill: state === "locking" || state === "capturing" ? cyan : "none",
      stroke: cyan,
      strokeWidth: "1.5",
      opacity: ringOpacity
    });
  }), state === "capturing" && /*#__PURE__*/React.createElement("circle", {
    cx: "200",
    cy: "200",
    r: "120",
    fill: "none",
...
function IrisLens() {
  ...
  const startCamera = useCallback(async () => {
    ...
    try {
      ...
      if (e.name === "NotAllowedError") setPermError("Camera access blocked. Enable it in browser settings.");else if (e.name === "NotFoundError") setPermError("No camera found on this device.");else setPermError("Could not start camera: " + e.message);
    }
  }, [loadLandmarker]);
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Iris", /*#__PURE__*/React.createElement("span", {
    style: {
      color: cyan
    }
  }, "Lens")), /*#__PURE__*/React.createElement("button", {
  ...
  }, "AI Iris Portrait"), /*#__PURE__*/React.createElement("h1", {
    style: {
  ...
  }, "See your iris", /*#__PURE__*/React.createElement("br", null), "like never before."), /*#__PURE__*/React.createElement("p", {
    style: {
      color: "#8a97a6",
      fontSize: 15,
      lineHeight: 1.6,
  ...
  }, "Advanced iris detection renders your unique eye structure in hyperreal macro detail."), /*#__PURE__*/React.createElement("button", {
  ...
  }, "Capture My Iris"))), screen === "capture" && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "fixed",
      inset: 0,
      background: "#000"
  ...
  }, hudState === "capturing" ? "Captured" : hudState === "locking" ? "Locking…" : "Scanning"), /*#__PURE__*/React.createElement("div", {
    style: {
      width: 44
    }
  ...
  }, procMsg), /*#__PURE__*/React.createElement("p", {
    style: {
      color: "#3a4856",
      fontSize: 12,
      letterSpacing: "0.08em"
    }
  }, "AI RENDERING — UP TO 30 SECONDS")) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 15,
      color: "#e8ecf2",
      marginBottom: 8
    ...
    onClick: () => {
      setGenError(null);
      if (lastCropRef.current) generate(lastCropRef.current, lastColorRef.current);else setScreen("capture");
    }
  }, "Try Again"), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-ghost",
    style: {
  ...
  }, "Your Iris Portrait"), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "relative",
      marginBottom: 32
    }
    ...
    onClick: async () => {
      try {
        ...
        a.href = url;
        a.download = `irislens-${Date.now()}.png`;
        a.click();
  ...
  }, "Capture Again"))), screen === "gallery" && /*#__PURE__*/React.createElement("div", {
    style: {
      minHeight: "100vh",
      padding: "32px 20px"
    }
  ...
  }, "No captures yet."), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-primary",
    style: {
      padding: "14px 32px"
    },
    onClick: () => setShowExplainer(true)
  }, "Capture My Iris")) : /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
  ...
  }, it.date))))), expanded && /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      maxHeight: "80vh",
      borderRadius: "50%",
      boxShadow: `0 0 60px rgba(0,212,255,.35)`
    }
  })), showExplainer && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "fixed",
      inset: 0,
  ...
  }, "IrisLens uses your camera to guide you through an iris capture. Everything processes on your device — nothing is uploaded."), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-primary",
    style: {
      padding: "14px",
      width: "100%"
