...
function IrisLens() {
  ...
  const startCamera = useCallback(async () => {
    ...
    try {
      ...
      if (e.name === "NotAllowedError") setPermError("Camera access was blocked. Enable it in your browser settings, then try again.");else if (e.name === "NotFoundError") setPermError("No camera found on this device.");else setPermError("Could not start the camera: " + e.message);
    }
  }, [loadLandmarker]);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      height: 200,
      borderRadius: "50%",
      background: "radial-gradient(circle at 40% 35%, #2a6b8a, #0a2330 60%, #05121a)",
    ...
    style: {
      ...
      borderRadius: "50%",
      background: "#05080c",
      boxShadow: `inset 0 0 30px rgba(0,212,255,.5)`
    }
  ...
  }, "Lens")), /*#__PURE__*/React.createElement("p", {
    style: {
      color: "#8a97a6",
      margin: "12px 0 40px",
      fontSize: 17
    }
  }, "See your iris like never before."), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-primary",
    style: {
      padding: "16px 40px"
    },
    onClick: () => setShowExplainer(true)
  }, "Capture My Iris"), /*#__PURE__*/React.createElement("button", {
  ...
  }, "View Gallery")), screen === "capture" && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "fixed",
      inset: 0,
      background: "#000"
    ...
    style: {
      ...
      fontSize: 18,
      fontWeight: 600,
      textShadow: "0 0 12px rgba(0,0,0,.9)"
    }
  ...
  }, "This can take up to 30 seconds")) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 16,
      color: "#e8ecf2",
      marginBottom: 8
    ...
    onClick: () => {
      if (lastCropRef.current) {
        setGenError(null);
        generate(lastCropRef.current, result?.color || "natural");
    ...
    style: {
      ...
      maxWidth: 340,
      borderRadius: "50%",
      boxShadow: `0 0 40px rgba(0,212,255,.3)`
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
  ...
  }, "Capture Again"), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-ghost",
    style: {
      padding: "14px"
    },
    onClick: () => setScreen("gallery")
  }, "View Gallery"))), screen === "gallery" && /*#__PURE__*/React.createElement("div", {
    style: {
      minHeight: "100vh",
      padding: "32px 20px"
    }
  ...
  }, /*#__PURE__*/React.createElement("p", null, "No captures yet. Your iris portraits will appear here."), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-primary",
    style: {
      padding: "14px 32px",
      marginTop: 16
    ...
    style: {
      ...
      maxHeight: "80vh",
      borderRadius: "50%",
      boxShadow: `0 0 50px rgba(0,212,255,.4)`
    }
  ...
  }, "Camera access needed"), /*#__PURE__*/React.createElement("p", {
    style: {
      color: "#8a97a6",
      fontSize: 15,
      lineHeight: 1.5,
  ...
  }, "IrisLens uses your camera to guide you to the perfect eye shot, then renders it into a detailed iris portrait."), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-primary",
    style: {
      padding: "14px 32px",
      width: "100%"
