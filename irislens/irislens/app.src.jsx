...
function IrisLens(){
  ...
  return(
    <div style={{minHeight:"100vh",background:"#000",color:"#fff",fontFamily:"'Inter', system-ui, sans-serif",overflowX:"hidden"}}>
      ...
      {screen==="home"&&(
        <div style={{height:"100vh",display:"flex",flexDirection:"column",position:"relative",overflow:"hidden",background:"#000"}}>
          ...
          <div style={{position:"relative",zIndex:2,marginTop:"auto",padding:"0 36px 56px",animation:"fadeUp 1s cubic-bezier(0.16,1,0.3,1) forwards"}}>
            ...
            <button className="btn-cyan" style={{width:"100%",maxWidth:340}} onClick={()=>{setShowNamePrompt(true);setNameInput("");setDisambigList(null);}}>
              Begin Scan
            </button>
          </div>
        </div>
          ...
          <div style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",width:"100%",padding:"16px 0",gap:40}}>
            ...
            <div style={{textAlign:"center",animation:"seatReveal 1s 1.6s cubic-bezier(0.16,1,0.3,1) both"}}>
              ...
              {result.name && result.seat!=="admin" && (
                <p style={{fontSize:12,fontWeight:400,letterSpacing:".08em",color:"rgba(255,255,255,.4)",marginTop:16,textTransform:"uppercase"}}>{result.name}</p>
              )}
            </div>
          </div>
      ...
      {/* ── NAME PROMPT ── */}
      {showNamePrompt&&(
        <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.92)",backdropFilter:"blur(20px)",display:"flex",alignItems:"center",justifyContent:"center",padding:24,zIndex:50,animation:"fadeIn 0.4s ease"}}>
          <div style={{background:"#0a0a0a",border:"1px solid rgba(255,255,255,.08)",padding:"44px 36px",maxWidth:400,width:"100%",textAlign:"center"}}>
            {!disambigList ? (
              <>
                <div style={{margin:"0 auto 22px",width:24,height:1,background:C,opacity:.7}}/>
                <span className="label" style={{display:"block",marginBottom:24,color:C}}>Identification</span>
                <p className="display" style={{fontSize:28,margin:"0 0 32px",lineHeight:1.1}}>
                  What's your<br/><span style={{fontStyle:"italic",color:"rgba(255,255,255,.55)"}}>name?</span>
                </p>
                <input
              ...
              <>
                <span className="label" style={{display:"block",marginBottom:16,color:C}}>Which one?</span>
                <p className="display" style={{fontSize:22,margin:"0 0 28px",fontStyle:"italic",color:"rgba(255,255,255,.6)"}}>
